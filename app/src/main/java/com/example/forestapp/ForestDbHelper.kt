...
class ForestDbHelper(context: Context) :
    ...
    override fun onCreate(db: SQLiteDatabase) {
        db.execSQL("""
            CREATE TABLE ${DatabaseContract.UserTable.TABLE_NAME} (
                ...
                ${DatabaseContract.UserTable.COLUMN_COINS} INTEGER DEFAULT 0,
                ${DatabaseContract.UserTable.COLUMN_TOTAL_FOCUS_TIME} INTEGER DEFAULT 0,
                ${DatabaseContract.UserTable.COLUMN_TREES_PLANTED} INTEGER DEFAULT 0,
                ${DatabaseContract.UserTable.COLUMN_REAL_TREES_PLANTED} INTEGER DEFAULT 0,
        ...
        db.execSQL("""
            CREATE TABLE ${DatabaseContract.SessionTable.TABLE_NAME} (
                ...
                ${DatabaseContract.SessionTable.COLUMN_DATE} TEXT,
                ${DatabaseContract.SessionTable.COLUMN_SUCCESSFUL} INTEGER,
                ${DatabaseContract.SessionTable.COLUMN_USER_ID} INTEGER,
                FOREIGN KEY (${DatabaseContract.SessionTable.COLUMN_USER_ID}) REFERENCES ${DatabaseContract.UserTable.TABLE_NAME}(${DatabaseContract.UserTable.COLUMN_ID})
            )
            """.trimIndent())
        ...
        db.execSQL("""
            CREATE TABLE ${DatabaseContract.TreeTable.TABLE_NAME} (
                ...
                ${DatabaseContract.TreeTable.COLUMN_PLANT_DATE} TEXT,
                ${DatabaseContract.TreeTable.COLUMN_DAYS_GROWN} INTEGER,
                ${DatabaseContract.TreeTable.COLUMN_IS_REAL_TREE} INTEGER,
                ${DatabaseContract.TreeTable.COLUMN_USER_ID} INTEGER,
                FOREIGN KEY (${DatabaseContract.TreeTable.COLUMN_USER_ID}) REFERENCES ${DatabaseContract.UserTable.TABLE_NAME}(${DatabaseContract.UserTable.COLUMN_ID})
            )""".trimIndent())
    }
